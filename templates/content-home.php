...
<section id="quem_somos">
    <div class="relative flex justify_center align_center width_100">
        <img class="logo_meio pt_100" src="<?= esc_url( get_template_directory_uri() . '/img/logo-colorida.png' ) ?>" alt="">
        <img class="ondas_rosa_cima" src="<?= URL . '/img/ondas_rosas_cima.svg' ?>" alt="">
    </div>
    <div class="apresent flex justify_center">
        <div class="sub_apresent flex align_center justify_center">
            <aside>
                ...
                <p>A carência nessas regiões não se resume ás políticas públicas apenas, mas também à dificuldade em captar recursos, implantar projetos e gerir as ações dos mesmos sem um norteamento da condução e domínio sobre “o que fazer” com os resultados das métricas apuradas.</p>
            ...
            <img src="<?= esc_url(get_template_directory_uri() . '/img/reuniao.jpg') ?>" alt="">
        </div>
    </div>
</section>
...
<section id="page_home" class="flex column gap_20 align_center">
    ...
    <img class="page_foto_1" src="<?= URL . '/img/ondas_rosas.svg' ?>" alt="">
