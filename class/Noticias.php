    ...
    class Noticias {
        ...
        public function get_noticias_home() {
            $args = array(
                ...
                'posts_per_page' => 7,      // Número de postagens a serem recuperadas
            ...
            if ($query->have_posts()) :
                ...
                while ($query->have_posts()) : $query->the_post();
                    $post_count++;
                ?>
                    <div class="post_box primeiro_post">
                        <a href="<?php the_permalink(); ?>">
                            <?php
                            if (has_post_thumbnail()) :
                                the_post_thumbnail('medium', array('class' => 'post_thumb'));
                            else:
                                echo '<img class="img_padrao" src="' . esc_url(DEFAULT_IMG_POST) . '" alt="Ilustração do link">';
                            endif; ?>
                        </a>
